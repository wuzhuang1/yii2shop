            ...
            <?php $form=\yii\bootstrap\ActiveForm::begin();?>
                <ul>
                    ...
                    <li>
                        ...
                        <input type="password" class="txt" name="Member[password_y]" />
                        <p> <span>请再次输入密码</p>
                    </li>
                    <li>
                        <label for="">邮箱：</label>
                    ...
                    <li>
                        ...
                        <input type="submit" onclick="bindPhoneNum(this)" id="get_captcha" value="获取验证码" style="height: 25px;padding:3px 8px"/>
                        </form>
                    </li>
                    <!--<li class="checkcode">
...
<div class="footer w1210 bc mt15">
    ...
    <p class="copyright">
        © 2005-2013 京西网上商城 版权所有，并保留所有权利。  ICP备案证书号:京ICP证072359号
    </p>
    <p class="auth">
...
<script type="text/javascript">
	...
	$.post('ajax-cart',{tel:tel},function(data){
		console.log(data);
	});
	};
</script>
