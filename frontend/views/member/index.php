                ...
                <div class="cat">
                    <h3><a href="/member/list?id=<?=$model->id?>"><?=$model->name?></a><b></b></h3>
                     <div class="cat_detail">
                         ...
                         <?php foreach($models as $model_1):
                               if($model_1->parent_id==$model->id):
                             ?>
                             <dl class="dl_1st">
                                <dt><a href="/member/list?id=<?=$model_1->id?>"><?=$model_1->name?></a></dt>
                                <dd>
                                    <?php foreach ($models as $model2):
                                        if($model2->parent_id==$model_1->id):
                                   ?>
                                    <a href="/member/list?id=<?=$model2->id?>"><?=$model2->name?></a>
                                            <?php endif;
                                            endforeach;?>
