...
<div class="mycart w990 mt10 bc">
    ...
    <table>
        ...
        foreach ($models as $model):
             $a+=$model['shop_price']*$carts[$model['id']]?>
        <tr data-id="<?=$model['id']?>">
            <td class="col1"><a href=""><img src="/images/cart_goods1.jpg" alt="" /></a>  <strong><a href=""><?=$model['name']?></a></strong></td>
            ...
            <td class="col6"><a href="shop-del?gid=<?=$model['id']?>">删除</a></td>
        </tr>
        <?php endforeach;?>
        ...
        <tfoot>
        <tr>
            <td colspan="6">购物金额总计： <strong>￥ <span id="total"><?=$a;?>.00</span></strong></td>
        </tr>
        </tfoot>
    </table>
