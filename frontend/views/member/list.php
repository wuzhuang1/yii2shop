        ...
        <div class="catlist">
            ...
            <div class="catlist_wrap">
                ...
                <div class="child">
                    ...
                    <h3 class="on"><b></b><?=$model1->name?></h3>
                    <ul>
                        <?php foreach ($models as $model2):
                                if($model1->id==$model2->parent_id):?>
                        <li><a href=""><?=$model2->name?></a></li>
                                <?php endif;
                        endforeach;?>
                    </ul>
    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <dt><a href="goods?id=<?=$good['id']?>"><img src="http://www.yii2shop.com<?=$good['logo']?>" alt="" /></a></dt>
                        <dd><a href="goods?id=<?=$good['id']?>"><?=$good['name']?></a></dt>
