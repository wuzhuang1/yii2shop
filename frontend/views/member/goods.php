    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="http://www.yii2shop.com<?=$goods->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="http://www.yii2shop.com<?=$goods->logo?>" width="352" height="352" alt="" />               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}"><img src="http://www.yii2shop.com<?=$goods->logo?>"></a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    <!--/*$a=time();
                        echo $a;
                    */-->
                    <!--f56c7432e1df975706b23e0cfc34feef85376249.jpg
                    www.yii2shop.com/*=$goods->logo*/-->
                ...
                <form action="<?=\yii\helpers\Url::to(['member/shop-vehicle'])?>" method="get" class="choose">
                    <ul>
                        <li>
                            <dl>
                                <dt>购买数量：</dt>
                        ...
                        <input type="hidden" name="gid" value="<?=$goods->id?>" class="amount"/>
                        <li>
                            <dl>
                                <dt>&nbsp;</dt>
                                <dd>
