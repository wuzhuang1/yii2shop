...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        ...
        <div class="address_hd">
            ...
            <dl>
                <dt><?=$row->name.$row->sid.$row->cid.$row->xid.$row->site.$row->tal?></dt>
                <dd>
                    <?=\yii\bootstrap\Html::a('修改',['edit','id'=>$row->id]);?>
                    <?=\yii\bootstrap\Html::a('删除',['del','id'=>$row->id]);?>
                    <a href=""><?=$row->status?'':'设置为默认地址'?></a>
                </dd>
            </dl>
            <?php endforeach;?>
        </div>
            ...
            <?php $form=\yii\bootstrap\ActiveForm::begin();?>
                <ul>
                    ...
                    <li>
                        ...
                        <select name="Address[sid]" id="province">
                            <option value="">+请选择省+</option>
                        </select>

                        <select name="Address[cid]" id="city">
                           <!-- <option value="">请选择</option>-->
                            <option value="">+请选择市+</option>
                        </select>

                        <select name="Address[xid]" id="area">
                            <!--<option value="">请选择</option>-->
                    ...
                    <li>
                        ...
                        <input type="text" name="Address[site]" class="txt address"  />-->
                        <?=$form->field($model,'site')->textInput(['class'=>'txt address'])?>
                    </li>
                    <li>
<!--                        <label for=""><span>*</span>手机号码：</label>
                        <input type="text" name="Address[tal]" class="txt" />-->
                        <?=$form->field($model,'tal')->textInput(['class'=>'txt'])?>
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
...
<!--<script src="<?/*=\yii::getAlias('@web')*/?>/js/jquery-1.11.0.js" type="text/javascript" charset="utf-8"></script>
...
<script>
    ...
    $("#province").change(function(){
        ...
        //清除区县数据
        $("#area").html('<option value="">+请选择县+</option>');
    });
